############################################################
## Script for calculation of SDD Quadratic resolution fit ##
############################################################
...
With a known source, we can calibrate the energy resolution
...
with open("AnalyseCalibSpectra_test.txt", "w") as file:
...
Res = [(calibFWHM[i]/calibEnergies152Eu[i]) for i in range(len(calibEnergies152Eu))]
