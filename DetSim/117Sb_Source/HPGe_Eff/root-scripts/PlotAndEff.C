...
void PlotAndEff(const char* filename){
    ...
    int nrCh = 4096; 
     ...
     // ROIs for each photopeak area calculation
        ...
        int binMaxGamma = hist1->FindBin(0.1590);
        // Ka
        int binMinKa = hist1->FindBin(0.0240);
        int binMaxKa = hist1->FindBin(0.0255);
        // Kb
        int binMinKb = hist1->FindBin(0.0280);
        int binMaxKb = hist1->FindBin(0.0295);
